...
<div className="2xl:text-[1.2em]  text-[0.89em] lg:mb-24 mb-10    flex flex-col lg:flex-row  sm:w-[90%] lg:w-[55em] 2xl:w-[65em] m-auto  gap-11 px-10  rounded-[1em] bg-white  text-stone-900 font-poppins lg:border-[2px] border-[15px] border-emerald-900">
  ...
  <div className='lg:w-1/2 lg:flex flex-col  lg:pt-20 pb-34'>
    ...
    <Link to="https://www.loom.com/share/ebe2b6107a2043e79ed8a027f1948f33?sid=73de4ac2-3bbb-42e0-a8eb-c0c51b8b8dc8" className='bg-blue-900  capitalize  rounded px-3 py-2 text-center w-fit text-white font-bold'>Video 1</Link>
    <Link to="https://www.loom.com/share/9370419c3ef141a2b6836c34990fbb87?sid=f7eba16d-e416-48b1-a63e-6fadc8c5586f" className='bg-blue-900  capitalize  rounded px-3 py-2 text-center w-fit text-white font-bold'>Video 2</Link>
    </div>
