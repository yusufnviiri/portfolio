...
<div className="2xl:text-[1.2em]  text-[0.89em] lg:mb-24 mb-10    flex flex-col lg:flex-row  sm:w-[90%] lg:w-[55em] 2xl:w-[65em] m-auto  gap-11 px-10  rounded-[1em] bg-white  text-stone-900 font-poppins lg:border-[2px] border-[15px] border-emerald-900">
  <div className='lg:w-1/2 lg:flex flex-col justify-around '>
  <h1 className='lg:pl-10 font-bold text-left my-10  lg:text-[3em] text-[2em]'><span className='underline underline-offset-[0.5em]'>D-SAC</span>CO</h1>
  ...
  <div className='lg:w-1/2 lg:flex flex-col  lg:pt-20 pb-34'>
    ...
    <Link to="https://github.com/yusufnviiri/dsaccofront.git" className='bg-blue-900  capitalize  rounded  text-white font-bold px-3 py-2 text-center'> Code Front-End</Link> 
  ...
  <div className="2xl:text-[1.2em] text-[0.89em] lg:mb-24 mb-10    flex flex-col lg:flex-row  sm:w-[90%] lg:w-[55em] 2xl:w-[65em] m-auto  gap-11 px-10  rounded-[1em] bg-white  text-stone-900 font-poppins lg:border-[2px] border-[15px] border-emerald-900">
  <div className='lg:w-1/2 lg:flex flex-col justify-around '>
  <h1 className=' lg:pl-10 font-bold text-left my-10  lg:text-[3em] text-[2em]'><span className='underline underline-offset-[0.5em]'>D-SCHO</span>OL</h1>
  <img src={astronount}  alt='dsacco' className='m-auto w-[90%] lg:h-[60%] h-[30em]  rounded' />
  </div>
  ...
  <div className='lg:w-1/2 lg:flex flex-col  lg:pt-20 pb-34'>
    ...
    <div className='flex flex-row    my-5 lg:text-[0.7em] 2xl:text-[0.98em]'>    <Link to="/dschool" className='bg-blue-900 mr-5 capitalize  rounded px-3 py-2 text-center  text-white font-bold'>Details</Link>
    <Link to="https://github.com/yusufnviiri/dschool.git" className='bg-blue-900 mr-5 capitalize  rounded  text-white font-bold px-3 py-2 text-center'> Code</Link>
     ...
     <Link to="https://www.loom.com/share/9370419c3ef141a2b6836c34990fbb87?sid=f7eba16d-e416-48b1-a63e-6fadc8c5586f" className='bg-blue-900 mr-5 capitalize  rounded  text-white font-bold px-3 py-2 text-center'> Video 1</Link>

     <Link to="https://www.loom.com/share/ebe2b6107a2043e79ed8a027f1948f33?sid=73de4ac2-3bbb-42e0-a8eb-c0c51b8b8dc8" className='bg-blue-900 mr-5 capitalize  rounded  text-white font-bold px-3 py-2 text-center'> Video 2</Link>
