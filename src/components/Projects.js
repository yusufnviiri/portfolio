...
<div className="text-[1.2em]   lg:h-[80vh] flex flex-col-reverse lg:flex-row  sm:w-[90%] lg:w-[55em] xl:w-[65em] m-auto  gap-16 px-10 lg:rounded-[4em] rounded-[1em] bg-white  text-stone-900 font-poppins lg:border-[30px] border-[15px] border-emerald-900">
  ...
  <div className='lg:w-1/2 '>
    ...
    <p  className='bg-green-950 p-3 text-yellow-500  text-[0.7em] w-2/3 text-center m-autotext-center'><span className='block uppercase font-bold text-yellow-300 text-[1.19em] '>languanges and frameworks </span> C#, MySQL and Entity Framework Core </p>
     </div>
