...
<div className="text-[1.2em] lg:mb-24 mb-10    flex flex-col lg:flex-row  sm:w-[90%] lg:w-[55em] xl:w-[65em] m-auto  gap-16 px-10  rounded-[1em] bg-white  text-stone-900 font-poppins lg:border-[2px] border-[15px] border-emerald-900">
  ...
  <div className='lg:w-1/2 lg:flex flex-col  lg:pt-20 pb-34'>
    ...
    <Link to="https://github.com/yusufnviiri/DsaccoAPP.git" className='bg-blue-900 mr-5 capitalize  rounded text-[0.9em] text-white font-bold px-3 py-2 text-center'> Code Back-End</Link> <Link to="https://www.loom.com/share/6aeb704e275a4ba38f6db027fc048a54?sid=99bd13f7-99ef-4806-9197-97735ba412fc" className='bg-blue-900 capitalize  px-3 py-2 text-center rounded  text-[0.9em] mr-5 text-white font-bold'>Video</Link>
    <Link to="https://github.com/yusufnviiri/dsaccofront.git" className='bg-blue-900  capitalize  rounded px-3 py-2 text-center text-[0.9em] text-white font-bold'>Code Front-End</Link>
    </div>
  ...
  <div className='lg:w-1/2 lg:flex flex-col  lg:pt-20 pb-34'>
    ...
    <div className='flex flex-row   my-10   '>
    <Link to="/dsacco" className='bg-blue-900 mr-5 capitalize  rounded px-3 py-2 text-center text-[0.9em] text-white font-bold'>Details</Link>
    <Link to="https://github.com/yusufnviiri/dschool.git" className='bg-blue-900 mr-5 capitalize  rounded text-[0.9em] text-white font-bold px-3 py-2 text-center'> Code</Link>
     <Link to="https://www.loom.com/share/6aeb704e275a4ba38f6db027fc048a54?sid=99bd13f7-99ef-4806-9197-97735ba412fc" className='bg-blue-900 capitalize  px-3 py-2 text-center rounded  text-[0.9em] mr-5 text-white font-bold'>Video</Link>
