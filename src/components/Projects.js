...
<div className="text-[1.2em]   lg:h-[80vh] flex flex-col-reverse lg:flex-row  sm:w-2/3 lg:w-[55em] xl:w-[65em] m-auto  gap-16 px-10 lg:rounded-[4em] rounded-[1em] bg-white  text-stone-900 font-poppins lg:border-[40px] border-[15px] border-emerald-900">
  <img src={astronount}  alt='dsacco' className='lg:w-1/2 lg:h-[37em] m-auto rounded' />
  <div className='lg:w-1/2 '>
    ...
    <Link to="/" className='bg-blue-900 capitalize  rounded text-[0.9em] text-white font-bold px-3 py-2 text-center'>Source Code</Link> <Link to="/" className='bg-blue-900 capitalize px-3 py-2 text-center rounded  text-[0.9em] text-white font-bold'>Video</Link>
    </div>
