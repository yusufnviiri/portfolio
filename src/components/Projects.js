...
<div className="text-[1.2em]  h-[80vh] flex flex-col lg:flex-row  sm:w-2/3 lg:w-[65em] m-auto  gap-16 px-10 rounded sm:bg-white md:bg-lime-500 lg:bg-rose-100 xl:bg-indigo-200 2xl:bg-sky-300 text-stone-900 font-poppins border-[40px] border-lime-900">
